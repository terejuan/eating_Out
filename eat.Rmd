...
As we can see in the fisherXY test, we observe that white and black are different based on the p value of 0.0003864, being that white group go out to more than black. The white and other are not different based on the p value of 0.3543, being that they both go out eat about the same. Black and others are not different based on the p value of .2815, both groups go out to eat the same.  
